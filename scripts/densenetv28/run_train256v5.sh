...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=docker.optum.com/dhanley2/bert:cgan_build \
            ...
            --logmsg Recursion-nocutmix-40ep-bugnegdiff --nbags 20  --epochs 40 --fold $FOLD  --lr 0.000025 --lrmult 20  --batchsize 32 --workpath scripts/$WDIR  \
            --cutmix_prob 0.0 --beta 1.0  --imgpath data/mount/256X256X6/ --weightsname weights/pytorch_nocut_model_densenet$FOLD.bin"
