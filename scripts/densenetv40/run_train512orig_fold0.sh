...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:apex_build \
            ...
            --logmsg Recursion-concat-$SIZE-fp16 --nbags 20  --epochs 60 --fold $FOLD  --lr 0.000025 --lrmult 20  --batchsize 32  --workpath scripts/$WDIR  \
            ...
            --frozenname frozen/pytorch_cut_model_512_densenet$FOLD.bin"
