...
dumpobj(os.path.join( WORK_DIR, '_emb_site{}_cls_{}_trn_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER, PROBS_NAME, fold)), rembls)
if fold!=5: dumpobj(os.path.join( WORK_DIR, '_emb_site{}_cls_{}_val_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER,PROBS_NAME, fold)), vembls)
dumpobj(os.path.join( WORK_DIR, '_emb_site{}_cls_{}_tst_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER, PROBS_NAME, fold)), tembls)    
dumpobj(os.path.join( WORK_DIR, '_df_site{}_cls_{}_trn_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER, PROBS_NAME, fold)), train_dfall)
if fold!=5: dumpobj(os.path.join( WORK_DIR, '_df_site{}_cls_{}_val_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER, PROBS_NAME, fold)), validdf)
dumpobj(os.path.join( WORK_DIR, '_df_site{}_cls_{}_tst_{}_fold{}.pk'.format(SITE, EXPERIMENTFILTER,  PROBS_NAME, fold)), test_df)
