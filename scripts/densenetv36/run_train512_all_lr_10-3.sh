...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:apex_build \
            ...
            --logmsg Recursion-addexptz_lr10e-3_$SIZE --nbags 30  --epochs 100 --fold $FOLD  --lr 0.000025 --lrmult 40  --batchsize 64  --workpath scripts/$WDIR  \
            --probsname probs_lr10e-3_$SIZE  --cutmix_prob 1.0 --precision half  --beta 1.0  --imgpath data/mount/512X512X6/ --weightsname weights/pytorch_cut_model_512_lr10e-3_densenet$FOLD.bin"
