...
class ImagesDS(D.Dataset):
    ...
    def __getitem__(self, index):
        ...
        stats_dict = statsgrpdf.loc[experiment].to_dict()
...
statsgrpdf = statsdf.groupby(['experiment', 'Channel'])['Mean', 'Std'].mean()
experiment_, _ = ['HEPG2-01', 'B03_s1_w1.png']
stats_dict = statsgrpdf.loc[(experiment_)].to_dict()
print(stats_dict)
