...
class ImagesDS(D.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img1 = self._load_img_as_tensor(pathnp1, 
                                       stats_dict['Mean'], #stats_dict['mean'], 
                                       stats_dict['Std'], #stats_dict['std'], stats_dict['illum_correction_function'],
                                       self.transform1)
...
class DensNet(nn.Module):
    def __init__(self, num_classes=1000, num_channels=6):
        ...
        self.classifier1 = nn.Linear(num_classes, num_classes, bias=True)
        del preloaded
