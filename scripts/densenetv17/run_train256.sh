...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=docker.optum.com/dhanley2/bert:cgan_build \
            ...
            --nbags 5  --epochs 40 --fold $FOLD  --lr 0.0001 --batchsize 16 --workpath scripts/$WDIR  \
            --imgpath data/mount/256X256X6/ --weightsname weights/pytorch_model_densenet$FOLD.bin"
