...
bsub  -q lowpriority -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:apex_build \
            -n 1 -R "span[ptile=4]" -o log_train_%J  sh -c "cd /share/dhanley2/recursion/scripts/$WDIR  && python3 ../../eda/post_processing_leak.py  \
             emb_bag12_finetuneU2v31_$WDIR.csv  emb_bag12_finetuneU2v31_$WDIR_ddlleak.csv "
