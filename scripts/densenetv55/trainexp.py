...
for epoch in range(EPOCHS-30, EPOCHS):
    if VALIDATE: 
        ...
        model.to(device)
        continue
    input_model_file = os.path.join( WORK_DIR.replace('v55', 'v53'), WEIGHTS_NAME.replace('.bin', '')+str(epoch)+'.bin'  )
