...
trainfull = pd.concat([traindf, 
                       ...
                       train_ctrl.drop('well_type', 1),
                       traindf[traindf.experiment.str.contains('U2')],  
                       #traindf[traindf.experiment.str.contains('U2')],
                       #train_ctrl[train_ctrl.experiment.str.contains('U2')].drop('well_type', 1),
                       #train_ctrl[train_ctrl.experiment.str.contains('U2')].drop('well_type', 1),
                       #test_ctrl[test_ctrl.experiment.str.contains('U2')].drop('well_type', 1),
                       #test_ctrl[test_ctrl.experiment.str.contains('U2')].drop('well_type', 1),
