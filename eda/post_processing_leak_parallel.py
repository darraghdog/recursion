...
def main():
    ...
    # df = pd.read_csv('/Users/dhanley2/Documents/Personal/recursion/sub/weights/v31/probs_v31_fold0.csv')
    ...
    def compute_best_score(expt):
        ...
        predpair = (np_predicts_argmax, idcodes)
        print("Complete id_code {}".format(expt))
        return predpair
    ...
    idcodes = []    #idcodes
    predpairs = pool.map(compute_best_score, unique_expt)
